---
title: 可访问性承诺
description: "@SITE_NAME@ 认识到所有用户都需要无障碍地访问使用它创建的网站和应用程序。"
layout: page
---

@SITE_NAME@ 认识到所有用户，无论其能力和设备如何，都需要无障碍地访问使用它创建的网站和应用程序。这是项目的重要目标。

通常，人们会问"@SITE_NAME@ 是否可访问？"我们不愿回答，因为可访问性不是二元的——没有简单的"是"或"否"可以提供。对于有视力的用户来说看似可访问的内容，对于无视力用户可能完全不可访问。即使您针对各种屏幕阅读器进行了优化，您仍然需要考虑低视力、色盲、听力障碍、行动障碍等等。
...
我对 @SITE_NAME@ 用户的承诺是：我们开发的每一件事都将以可访问性为考量。我们将尽最大努力和知识测试和改进每个组件。我们将在合理范围内尽最大努力解决上游问题，例如浏览器错误和限制。
...
这是前进的道路。我们将一起继续让 @SITE_NAME@ 对尽可能多的用户保持可访问。
