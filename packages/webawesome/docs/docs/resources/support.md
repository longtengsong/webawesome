...
<p>我们知道人们有自己的联系方式，因此我们的团队确保您可以在任何需要的地方找到我们——无论是在 GitHub 上提交问题、在 Discord 上与社区聊天，还是通过电子邮件获得私人帮助。如果您刚刚开始，请不要错过我们的<a href="/docs/">安装指南</a>。</p>
...
<div class="wa-stack wa-align-items-start">
  <div class="wa-stack wa-gap-s">
    ...
    <span class="wa-heading-m">功能请求和错误报告</span>
    <p class="wa-caption-l">发现了错误或有想法？在 GitHub 上提交问题，以便我们分类、追踪并推送修复。</p>
  </div>
  <ul>
    <li>报告带有清晰步骤的可复现错误。</li>
    <li>建议改进开发者工作流程的功能</li>
    <li>对他人的问题进行投票以帮助我们确定优先级。</li>
  </ul>
...
<div class="wa-stack wa-align-items-start">
  <div class="wa-stack wa-gap-s">
    ...
    <span class="wa-heading-m">社区与讨论</span>
    <p class="wa-caption-l">实时提问、分享技巧并与其他开发者交流。</p>
  </div>
  <ul>
    <li>寻求帮助</li>
    <li>分享想法并获得反馈</li>
...
<div class="wa-stack wa-align-items-start">
  <div class="wa-stack wa-gap-s">
    <h2 class="anchor-heading"><wa-icon name="envelope" variant="regular"></wa-icon>电子邮件</h2>
    <span class="wa-heading-m">其他事项</span>
    <p class="wa-caption-l">账单问题、账户访问或敏感问题——直接联系我们的支持团队。</p>
  </div>
  <ul>
    <li>账户访问和登录问题。</li>
    <li>账单或订阅问题。</li>
